...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
	if (indexPath.row == 0) cell.textLabel.text = @"0_Maximus_0";
	else if (indexPath.row == 1) cell.textLabel.text = @"ifish12";
	else cell.textLabel.text = @"Settings";
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (![cell.textLabel.text isEqualToString:@"Settings"]) {
		if ([cell.textLabel.text isEqualToString:@"0_Maximus_0"]) cell.imageView.image = [UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:@"http://a1.twimg.com/profile_images/1257933058/icon-1__dragged__reasonably_small.png"]]];
		else cell.imageView.image = [UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:@"http://a2.twimg.com/profile_images/1437252415/image_reasonably_small.jpg"]]];
...
- (void)requestSucceeded:(NSString *)connectionIdentifier {
	NSLog(@"0.0 %@", connectionIdentifier);
}
- (void)requestFailed:(NSString *)connectionIdentifier withError:(NSError *)error {
	NSLog(@"0.0 %@ %@", connectionIdentifier, [error localizedDescription]);
}
